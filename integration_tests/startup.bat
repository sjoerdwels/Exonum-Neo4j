...
::docker run -t -d -i --name node5 -p 8205:8200 -p 7475:7474 -p 7685:7687 -p 3005:3005 -v TestVolume:/shared-config exonum_neo4j
...
for /l %%i in (1, 1, %node_count%) do (
    ...
    docker exec -w /Exonum-Neo4j/ node%%i git checkout -f master
